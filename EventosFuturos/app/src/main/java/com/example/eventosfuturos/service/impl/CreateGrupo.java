...
public class CreateGrupo extends AsyncTask<String,Object, Boolean> {

    private TaskCompleted listener;

    public CreateGrupo(TaskCompleted listener) {
    ...
    protected Boolean doInBackground(String... strings) {
        try {
            URL url = new URL("https://proyectoandroidjesuschavero.000webhostapp.com/createGrupo.php");
