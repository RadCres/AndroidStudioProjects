...
public class NacionalidadOM {
    ...
    public static List<Nacionalidad> getList() {
        ...
        Image[] banderas = {R.drawable.portugal_flags_flag_17054,R.drawable.romania_flags_flag_17057,R.drawable.morocco_flags_flag_17039,R.drawable.colombia_flags_flag_16986,R.drawable.uruguay_flags_flag_17081,R.drawable.nicaraguaflag_6444,R.drawable.argentina_flags_flag_16969,
